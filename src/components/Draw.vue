    ...
    <div id="sketchOuter">
      ...
      <div id="brushSizeBar" v-if="showBrush">
        ...
        >
          <div
            class="brushSizeIcon"
            :style="{width: size + 'px', height: size + 'px', marginTop: (-size/2) + 'px'}"
          ></div>
        ...
        <div id="toolBar" v-show="toolBarShow">
          <div class="tool">
            <div
              ...
              @click="showPalette = true; erase = false"
            ></div>
          </div>
          <div class="tool" @click="showBrush = true; erase = false">
            ...
            <div
              id="brushSample"
              :style="{width: current.width + 'px', height: current.width + 'px'}"
              v-else
            ></div>
          </div>
        ...
        <div id="endGamePanel">
          ...
          <div id="backCont">
            ...
            <x-button
              ...
              mini
              type="primary"
              @click.native="$router.replace(`/room/${roomId}`)"
            >返回房间</x-button>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    clearCanvas() {
      ...
      this.redoStrokes = [];
      this.undoStrokes = [];
      this.$refs.undoLabel.style.color = this.$refs.redoLabel.style.color = this.unableDoColor; //undo和redo变为灰色
      this.erase = false;
    },
